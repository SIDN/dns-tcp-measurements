...
do_one_measurement () {
    ...
    kill "$stats_PID"
    # Then kill the bind podman container
    kill "$pman_PID"
    sleep 10
    kill "$pman_PID"
    wait "$pman_PID"
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/0_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/10_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/20_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/30_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/40_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/50_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/60_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/70_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/80_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/90_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/bind/100_tcp_host_${timestamp_str}_$measurement.json"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
