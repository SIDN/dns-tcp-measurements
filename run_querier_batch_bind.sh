...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "0" "145.102.0.142:4242" "output/bind/querier_0_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "10" "145.102.0.142:4242" "output/bind/querier_10_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "20" "145.102.0.142:4242" "output/bind/querier_20_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "30" "145.102.0.142:4242" "output/bind/querier_30_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "40" "145.102.0.142:4242" "output/bind/querier_40_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "50" "145.102.0.142:4242" "output/bind/querier_50_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "60" "145.102.0.142:4242" "output/bind/querier_60_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "70" "145.102.0.142:4242" "output/bind/querier_70_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "80" "145.102.0.142:4242" "output/bind/querier_80_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "90" "145.102.0.142:4242" "output/bind/querier_90_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "100" "145.102.0.142:4242" "output/bind/querier_100_tcp_${timestamp_str}_$measurement.out"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
