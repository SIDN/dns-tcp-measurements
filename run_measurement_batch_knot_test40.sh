...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/20_tcp_host_${timestamp_str}_$measurement.json" "20"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/30_tcp_host_${timestamp_str}_$measurement.json" "30"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/40_tcp_host_${timestamp_str}_$measurement.json" "40"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/50_tcp_host_${timestamp_str}_$measurement.json" "50"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/60_tcp_host_${timestamp_str}_$measurement.json" "60"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/70_tcp_host_${timestamp_str}_$measurement.json" "70"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/80_tcp_host_${timestamp_str}_$measurement.json" "80"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/90_tcp_host_${timestamp_str}_$measurement.json" "90"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
...
do 
    ...
    do_one_measurement "test-csv/n1-1h-anon.csv" "stats-output/knot/40test/100_tcp_host_${timestamp_str}_$measurement.json" "100"
    date_string=$(date +"%d-%m-%Y_%H:%M:%S")
